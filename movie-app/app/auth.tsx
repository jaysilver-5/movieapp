  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#1a1a2e" }}>
      {loading && (
        ...
        >
          <ActivityIndicator size="large" color="#ff0cfe" />
        </View>
      )}
      ...
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: 24 }}>
        ...
        <TouchableOpacity onPress={() => setIsLogin(!isLogin)} style={{ marginTop: 16 }}>
          <Text style={{ color: "#ff0cfe", textDecorationLine: "underline", textAlign: "center" }}>
                          ...
                          >
                            <Image
                              ...
                              style={{
                                ...
                                borderRadius: 32,
                                borderWidth: 2,
                                borderColor: avatar === selectedAvatar ? "#ff0cfe" : "transparent",
                              }}
                            />
                          </TouchableOpacity>
                        ))}
